...
int main()
{
    ...
    HashMap<int, std::string> myHashTable;
    ...
    catch (std::out_of_range &e)
    {
        std::cout << "Ocurrio un error: " << e.what() << std::endl
                  << "No se modifico la tabla" << std::endl;
    }
    std::cout << "Table current size: " << myHashTable.getSize() << std::endl;
    myHashTable.print();

    std::cout << "Find 51: " << std::endl;
    std::cout << "Result index: " << myHashTable.find(51) << std::endl;

    std::cout << "Find 50: " << std::endl;
    std::cout << "Result index: " << myHashTable.find(50) << std::endl;

    std::cout << "Find 86: " << std::endl;
    std::cout << "Result index: " << myHashTable.find(86) << std::endl;
    std::cout << "Find 86: " << std::endl;
